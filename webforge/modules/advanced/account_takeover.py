...
CVSS40_RESET_TOKEN = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:N/SC:N/SI:N/SA:N"
CVSS_ENUM         = "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N"
CVSS40_ENUM       = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:L/VI:N/VA:N/SC:N/SI:N/SA:N"
CVSS_HOST_POISON  = "CVSS:3.1/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:N"
CVSS40_HOST_POISON = "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:P/VC:H/VI:H/VA:N/SC:N/SI:N/SA:N"
RESET_PATHS = [
    ...
    async def _test_token_entropy(self, reset_url: str, target: str) -> None:
        ...
        if tokens:
            ...
            self.new_finding(
                ...
                cvss_v40_vector=CVSS40_RESET_TOKEN,
                target=target,
                url=reset_url,
            )
